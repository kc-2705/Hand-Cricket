...
def redrawWindow(wind, game, p, game_over=False, out_message=""):
    ...
    if game_over:
        ...
        if game.get_player_score(0) < game.get_player_score(1):
            ...
            winner_text = font.render("It's a tie", 1, (0, 0, 128))  # Red color for tie text
...
def main():
    ...
    while run:
        ...
        if game.bothWent():
            ...
            player2_done_batting = game.done_bat[1]
            player2_score = game.get_player_score(1)
            player1_score = game.get_player_score(0)
            scores_are_equal = player2_score == player1_score

            # 'Game Over' conditions
            game_over_conditions_met = (player1_done_batting and player2_done_batting and scores_are_equal) or \
                                       (player2_done_batting and player1_score > player2_score) or \
                                       (not player2_done_batting and player2_score > player1_score)
